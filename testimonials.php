<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
        <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center" data-aos="fade-up">
        ...
        <div class="flex flex-wrap -m-4">
            <?php foreach ($content['testimonials']['items'] as $index => $testimonial): ?>
                <div class="p-4 md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="<?= $index * 200 ?>">
                    <div class="h-full bg-gray-100 p-8 rounded shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                40.501 35.2 65.301 24.399z">
                        ...
                        <p class="leading-relaxed mb-6 italic text-gray-700">
                        ...
                        <a class="inline-flex items-center">
                            ...
                            <span class="flex-grow flex flex-col pl-4">
                                <span class="title-font font-semibold text-gray-900">
