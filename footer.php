<footer class="text-gray-600 dark:text-gray-300 body-font bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav class="list-none mb-10">
            <?php foreach ($column['links'] as $link): ?>
              <li>
                <a class="text-gray-600 dark:text-gray-400 hover:text-purple-500" href="#"><?= htmlspecialchars($link) ?></a>
              </li>
            <?php endforeach; ?>
          </nav>
        </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            <label for="footer-field" class="leading-7 text-sm text-gray-600 dark:text-gray-400">
              <?= htmlspecialchars($content['footer']['subscribe']['label']) ?>
            </label>
            <input type="text" id="footer-field" name="footer-field"
              placeholder="<?= htmlspecialchars($content['footer']['subscribe']['label']) ?>"
              class="w-full bg-gray-100 dark:bg-gray-800 dark:text-white bg-opacity-50 rounded border border-gray-300 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-700 focus:ring-2 focus:ring-purple-200 focus:border-purple-500 text-base outline-none text-gray-700 dark:text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
          </div>
          <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">
            <?= htmlspecialchars($content['footer']['subscribe']['button']) ?>
          </button>
        </div>
        <p class="text-gray-500 dark:text-gray-400 text-sm mt-2 md:text-left text-center">
  ...
  <!-- Facebook -->
  <a class="text-[#1877F2] hover:text-[#0e63d6]" href="<?= htmlspecialchars($content['footer']['bottom']['socials']['facebook']) ?>" target="_blank">
  ...
  <!-- Twitter -->
  <a class="ml-3 text-[#1DA1F2] hover:text-[#0d8ae5]" href="<?= htmlspecialchars($content['footer']['bottom']['socials']['twitter']) ?>" target="_blank">
    <svg fill="currentColor" class="w-5 h-5" viewBox="0 0 24 24">
  ...
  <!-- Instagram -->
  <a class="ml-3 text-[#E1306C] hover:text-[#c01a56]" href="<?= htmlspecialchars($content['footer']['bottom']['socials']['instagram']) ?>" target="_blank">
  ...
  <!-- LinkedIn -->
  <a class="ml-3 text-[#0A66C2] hover:text-[#004182]" href="<?= htmlspecialchars($content['footer']['bottom']['socials']['linkedin']) ?>" target="_blank">
    <svg fill="currentColor" class="w-5 h-5" viewBox="0 0 24 24">
