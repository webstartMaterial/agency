  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-10">
      <?php foreach ($content['services']['items'] as $index => $item): ?>
        <div class="hover:ring-2 hover:ring-purple-500 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl"
            data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>">
          <img src="<?= $item['img'] ?>"
            alt="<?= htmlspecialchars($item['title']) ?>" class="rounded w-full h-48 object-cover mb-4">
