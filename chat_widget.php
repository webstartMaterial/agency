...
<div id="chat-widget" class="fixed bottom-4 right-4 z-50 flex flex-col items-end">
    ...
    <button id="chat-toggle"
        class="<?= $bgPrimary;?> hover:<?= $bgPrimaryHover; ?> <?= $textWhiteLightMode; ?> dark:<?= $textTitle; ?> px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
    ...
    <!-- Chat Window -->
    <div id="chat-box"
        class="hidden w-80 bg-white dark:<?= $bgSecondary ;?> rounded-lg shadow-xl mt-4 overflow-hidden flex flex-col">
