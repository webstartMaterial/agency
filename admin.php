...
// Récupère toutes les conversations avec nombre de messages non lus
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-800" id="chat-container">
                    <?php foreach ($messages as $msg): ?>
                        <div class="<?= $msg['sender'] === 'admin' ? 'text-right' : 'text-left' ?>">
                            ...
                            <br><small class="text-xs text-gray-400">
    ...
    <script>
        ...
        async function refreshChat() {
            ...
            messages.forEach(msg => {
                ...
                container.innerHTML += `<div class="${align}"><span class="inline-block px-4 py-2 rounded ${bg}">${msg.message}</span><br><small class="text-xs text-gray-400">${msg.sender}</small></div>`;
            });
