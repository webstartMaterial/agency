<section class="bg-gray-100 <?= $textParagraphLightMode; ?> dark:text-gray-300 body-font  dark:<?= $bgSecondary; ?> transition-colors duration-300">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div data-aos="fade-right"
      ...
      <h1
        class="sm:text-4xl lg:text-4xl text-4xl font-extrabold tracking-tight title-font <?= $textTitleLightMode;?> dark:<?= $textTitle;?> mb-6">
      ...
      <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
        <a href="?/#offers"
          class="inline-flex items-center px-6 py-3 <?= $textWhiteLightMode ?> <?= $bgPrimary;?> hover:<?= $bgPrimaryHover; ?> dark:<?= $textTitle; ?> text-lg font-semibold rounded-2xl shadow-lg transition duration-300 ease-in-out">
          <i class="ti-bag mr-2 text-xl leading-none"></i>
          <?= htmlspecialchars($content['header']['button1']) ?>
        </a>

        <a href="?/#contact"
          class="inline-flex items-center px-6 py-3 <?= $textWhiteLightMode ?> <?= $bgQuartenary;?> hover:<?= $bgQuartenaryHover; ?> dark:<?= $textTitle; ?> text-lg font-semibold rounded-2xl shadow-lg transition duration-300 ease-in-out">
